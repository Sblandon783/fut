...
class CreateRoutine extends StatefulWidget {
  ...
  const CreateRoutine({Key? key, required this.routine}) : super(key: key);
...
class CreateRoutineState extends State<CreateRoutine> {
  ...
  @override
  void initState() {
    _routineNameController
        .addListener(() => widget.routine.name = _routineNameController.text);
    super.initState();
  }
  ...
  Future getImage(ImageSource media) async {
    ...
    widget.routine.image = base64string;
    setState(() => image = img);
  }
